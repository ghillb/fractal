export const REPOSITORY_CAPABILITY_SURFACE_VERSION = 28 as const;

export type RepositoryCapabilitySurface = Readonly<{
  schemaVersionSurfaceExportBoundaryVersionedField: typeof schemaVersionSurfaceExportBoundaryVersionedField;
  ...
  schemaVersionSurfaceLineage: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-lineage/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSchemaShapeFingerprint: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-schema-shape-fingerprint/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  schemaVersionSurfaceImmutabilityWitnessReadOnly: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-immutability-witness-read-only/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  schemaVersionSurfaceDerivedVersion: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-derived-version/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceDerivedVersionTag: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-derived-version-tag/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  exportStabilityWitness: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-export-stability/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  shallowImmutabilitySummary: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: "shallow-immutability-summary";
    derived: true;
  }>;
  ...
  sourceFingerprint: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: "src/repository-capability-surface.ts@15";
    derived: true;
  }>;
  schemaVersionVersionedField: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    schemaVersion: 4;
    readOnly: true;
    derived: true;
  ...
  schemaVersionSurfaceVersionLabelDerivedSummary: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
  ...
  schemaVersionSurfaceVersionLabelDerivedAudit: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-version-label-derived-audit/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceVersionLabelDerivedStability: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-version-label-derived-stability/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceVersionLabelDerivedVersionedField: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
  ...
  schemaVersionShallowImmutabilityCheck: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-shallow-immutability-check/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  schemaVersionBoundarySchemaVersion: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    schemaVersion: 4;
    readOnly: true;
    derived: true;
  ...
  schemaVersionSurfaceSchemaStability: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-schema-stability/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceSchemaStabilityWitness: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-schema-stability-witness/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionDerivedPublicBoundary: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-derived-public-boundary/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  schemaVersionSurfaceVersionLabelDerivedImmutableWitness: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-version-label-derived-immutable-witness/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceExportBoundaryVersionedFieldSnapshot: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-derived-public-boundary-snapshot/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceSchemaShapeVersionedField: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    schemaVersion: 4;
    readOnly: true;
    derived: true;
  ...
  schemaVersionSurfaceDerivedImmutabilityShape: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    schemaVersion: 4;
    readOnly: true;
    derived: true;
  ...
  schemaVersionSurfaceVersionLabelChecksum: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-version-label-checksum/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  ...
  schemaVersionSurfaceVersionChecksum: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-version-checksum/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionSurfaceImmutabilitySummary: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-surface-immutability-summary/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
  schemaVersionInspectionStamp: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
  ...
  schemaVersionSchemaStabilityReport: Readonly<{
    version: typeof REPOSITORY_CAPABILITY_SURFACE_VERSION;
    value: `repository-capability-surface-schema-stability-report/v${typeof REPOSITORY_CAPABILITY_SURFACE_VERSION}`;
    derived: true;
  }>;
}>;

export const schemaVersionSurfaceExportBoundaryVersionedField = Object.freeze({
...
export const schemaVersionSurfaceVersionLabelDerivedVersionedImmutableField = Object.freeze({
  version: REPOSITORY_CAPABILITY_SURFACE_VERSION,
  value: `repository-capability-surface-surface-version-label-derived-versioned-immutable-field/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`,
  derived: true
});
...
const repositoryCapabilitySurface: RepositoryCapabilitySurface = Object.freeze({
  ...
  schemaVersionSurfaceLineage: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-lineage/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  schemaVersionSchemaShapeFingerprint: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-schema-shape-fingerprint/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  ...
  schemaVersionSurfaceImmutabilityWitnessReadOnly: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-immutability-witness-read-only/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  ...
  schemaVersionSurfaceDerivedVersionTag: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-derived-version-tag/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  ...
  exportStabilityWitness: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-export-stability/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  shallowImmutabilitySummary: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: "shallow-immutability-summary", derived: true }),
  ...
  sourceFingerprint: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: "src/repository-capability-surface.ts@15", derived: true }),
  schemaVersionVersionedField: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, schemaVersion: 4, readOnly: true, derived: true, stableShape: true }),
  ...
  schemaVersionBoundarySchemaVersion: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, schemaVersion: 4, readOnly: true, derived: true, stableShape: true }),
  ...
  schemaVersionSurfaceSchemaStability: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-schema-stability/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  schemaVersionSurfaceSchemaStabilityWitness: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-schema-stability-witness/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  schemaVersionDerivedPublicBoundary: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-derived-public-boundary/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  ...
  schemaVersionSurfaceVersionLabelDerivedImmutableWitness: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-version-label-derived-immutable-witness/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  schemaVersionSurfaceExportBoundaryVersionedFieldSnapshot: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-derived-public-boundary-snapshot/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
  schemaVersionSurfaceSchemaShapeVersionedField: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, schemaVersion: 4, readOnly: true, derived: true, stableShape: true }),
  schemaVersionSurfaceDerivedImmutabilityShape: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, schemaVersion: 4, readOnly: true, derived: true, stableShape: true }),
  ...
  schemaVersionSurfaceVersionLabelChecksum: Object.freeze({ version: REPOSITORY_CAPABILITY_SURFACE_VERSION, value: `repository-capability-surface-surface-version-label-checksum/v${REPOSITORY_CAPABILITY_SURFACE_VERSION}`, derived: true }),
...
export const schemaVersionVersionedField = repositoryCapabilitySurface.schemaVersionVersionedField;
...
export const exportStabilityWitness = repositoryCapabilitySurface.exportStabilityWitness;
export const shallowImmutabilitySummary = repositoryCapabilitySurface.shallowImmutabilitySummary;
...
export const schemaVersionSurfaceSchemaStability = repositoryCapabilitySurface.schemaVersionSurfaceSchemaStability;
export const schemaVersionSurfaceSchemaStabilityWitness = repositoryCapabilitySurface.schemaVersionSurfaceSchemaStabilityWitness;
export const schemaVersionSurfaceFingerprint = repositoryCapabilitySurface.schemaVersionSurfaceFingerprint;
export const schemaVersionSurfaceLineage = repositoryCapabilitySurface.schemaVersionSurfaceLineage;
export const schemaVersionSchemaShapeFingerprint = repositoryCapabilitySurface.schemaVersionSchemaShapeFingerprint;
...
export const schemaVersionSurfaceImmutabilityWitnessReadOnly = repositoryCapabilitySurface.schemaVersionSurfaceImmutabilityWitnessReadOnly;
...
export const schemaVersionSurfaceDerivedVersionTag = repositoryCapabilitySurface.schemaVersionSurfaceDerivedVersionTag;
...
export const schemaVersionSurfaceVersionLabelDerivedImmutableWitness = repositoryCapabilitySurface.schemaVersionSurfaceVersionLabelDerivedImmutableWitness;
...
export const schemaVersionBoundarySchemaVersion = repositoryCapabilitySurface.schemaVersionBoundarySchemaVersion;
export const schemaVersionSurfaceVersionLabel = repositoryCapabilitySurface.schemaVersionSurfaceVersionLabel;
export const schemaVersionSurfaceVersionLabelChecksum = repositoryCapabilitySurface.schemaVersionSurfaceVersionLabelChecksum;
...
export const schemaVersionSchemaStabilityReport = repositoryCapabilitySurface.schemaVersionSchemaStabilityReport;
...
export const schemaVersionSurfaceExportBoundaryVersionedFieldSnapshot = repositoryCapabilitySurface.schemaVersionSurfaceExportBoundaryVersionedFieldSnapshot;
export const schemaVersionSurfaceSchemaShapeVersionedField = repositoryCapabilitySurface.schemaVersionSurfaceSchemaShapeVersionedField;
export const schemaVersionSurfaceDerivedImmutabilityShape = repositoryCapabilitySurface.schemaVersionSurfaceDerivedImmutabilityShape;
